...
import '../../../css/admin/fileInputPlaybook.css'
...
const UploadPlaybook = ({setLinks,type,fileName,setFileName}) => {
    ...
    return (
      ...
      <div className='wrappers'>
            <div className="upload-btn-wrappers">
              <img src={upload} className="imgs"/>
              <button className="btns">Select File to Upload</button>
